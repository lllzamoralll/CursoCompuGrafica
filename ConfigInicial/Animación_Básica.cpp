...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Practica 10, Sanchez Zamora Jesus", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		model = glm::rotate(model, tiltDog, glm::vec3(1.0f, 0.0f, 0.0f)); // inclinaci�n hacia adelante o atr�s
